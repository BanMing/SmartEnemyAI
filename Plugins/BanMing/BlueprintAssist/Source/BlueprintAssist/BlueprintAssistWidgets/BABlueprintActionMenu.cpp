...
#include "BABlueprintActionMenu.h"
...
void SBABlueprintActionMenu::InitListItems(TArray<TSharedPtr<FBAActionMenuItem>>& Items)
{
	double ThisTime = 0;
	{
		...
		{
			TSharedPtr<FEdGraphSchemaAction>& SchemaAction = MenuBuilder.GetSchemaAction(i);
			Items.Add(MakeShared<FBAActionMenuItem>(SchemaAction));
